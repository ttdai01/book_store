...
exports.getJsonSecret = exports.getSecret = exports.region = void 0;
const AWS = __importStar(require("aws-sdk"));
exports.region = 'us-east-1';
const client = new AWS.SecretsManager({
    region: exports.region
});
function getSecret(secretName = 'book-store-app') {
    return client.getSecretValue({ SecretId: secretName }).promise().then(data => data.SecretString);
}
exports.getSecret = getSecret;
function getJsonSecret(key, secretName = `book-store-app`) {
